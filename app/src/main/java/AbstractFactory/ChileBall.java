 ...
 */
public class ChileBall extends AbstractBall {

    private Resources mImage;
    private final Paint mPainter = new Paint();


    public ChileBall(Context context, int widthDisplay, int heightDisplay) {
        super(context, widthDisplay, heightDisplay);
        this.mImage = mImage;
        mBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.balonchile);
